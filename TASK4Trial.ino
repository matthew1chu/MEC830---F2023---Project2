...
const unsigned long moveDuration1 = 2400;
const unsigned int numIterations1 = 4;
unsigned int iterationCount1 = 0;
bool isMovingForward1 = true;
...
if (iterationCount1 < numIterations1){
  if (isMovingForward1) {
    isDriving = true;
    lastRead = check;

    if (elapsedTime1 >= moveDuration1) {
